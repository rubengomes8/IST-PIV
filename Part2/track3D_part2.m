...
for i=1:length(imgseq1(:))
    ...
    im_diffiltered21 = segment(im_diffiltered21,r1(i).res_xyz(:,:,3));
    ...
    im_diffiltered22 = segment(im_diffiltered22,r2(i).res_xyz(:,:,3));
    ...
    %PARA A BOX 1
    if indice1 == 1% first frame, store all objects!       
